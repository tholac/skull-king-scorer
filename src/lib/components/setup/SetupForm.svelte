...
<div class="max-w-lg mx-auto py-8 px-4">
  <h1 class="text-3xl font-bold mb-6">☠️ Skore King</h1>
  ...
  <section class="mb-6">
    ...
    {/each}
    <button class="btn btn-ghost btn-sm mt-1" onclick={addRow}>+ Add player</button>
  </section>
  ...
  <section class="mb-4">
    <h2 class="font-semibold mb-2">Ruleset</h2>
    <div class="join">
  ...
  <section class="mb-6">
    <h2 class="font-semibold mb-2">Scoring method</h2>
    <div class="join">
      {#each (['classic', 'rascal'] as const) as m}
        <button
          class="btn join-item"
          class:btn-primary={scoringMethod === m}
          onclick={() => (scoringMethod = m)}
