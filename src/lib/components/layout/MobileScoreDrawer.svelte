...
{#key $languageStore}
<div class="lg:hidden fixed bottom-4 right-2 z-50">
  <button class="btn btn-primary btn-circle btn-lg shadow-lg" onclick={() => (open = true)}>
    🏆
  </button>
</div>
